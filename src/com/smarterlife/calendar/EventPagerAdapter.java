...
public class EventPagerAdapter extends android.support.v4.app.FragmentPagerAdapter{
  ...
  public EventPagerAdapter(Event event, FragmentManager fm, Context c ) {
        super(fm);
        context = c;
        this.event = event;
    ...
    public Fragment getItem(int position) {
    	...
    	if(position ==0 )
    	{ 
   		EventFrag_L eventFrag_L = new EventFrag_L();
