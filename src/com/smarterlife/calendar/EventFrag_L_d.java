...
public class EventFrag_L_d extends Fragment  implements OnDismissListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.lyt_event_item_l_d, container,false);
...
//    }
	...
	private void PopulateView(View v) {
		...
		TextView  txtEventTitle =  (TextView)v.findViewById(R.id.txt_event_l_d);
		
		txtEventTitle.setText( String.valueOf( event.getEventName().toString()));
